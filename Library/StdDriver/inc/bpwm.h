...
#define BPWM_SSCTL_SSRC_BPWM2                     (2UL<<BPWM_SSCTL_SSRC_Pos)    /*!< Synchronous start source comes from BPWM2 */
#define BPWM_SSCTL_SSRC_BPWM3                     (3UL<<BPWM_SSCTL_SSRC_Pos)    /*!< Synchronous start source comes from BPWM3 */
