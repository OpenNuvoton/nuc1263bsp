...
{    
    ...
    PDMA->REQSEL0_3 |= (PDMA_I3C0_RX << PDMA_REQSEL0_3_REQSRC0_Pos);
...
{    
    ...
    PDMA->REQSEL0_3 |= (PDMA_I3C0_TX << PDMA_REQSEL0_3_REQSRC1_Pos);
                ...
                if(g_u32RespStatus == I3C_STS_NO_ERR)
                {
                    ...
                    do {
                        if(I3C_IS_RESP_RX(g_RespQ[qn]))
                        {
                            ...
                            u8TID = (pu8Data[0] % 8);
                            I3C_SetCmdQueueAndData(I3C0, u8TID, NULL, u16Len);
                            /* Enable I3C PDMA transmit function */
                            I3C_EnableTxPDMA(I3C0, (uint32_t)(&g_TxBuf[0]), (uint32_t)(&I3C0->TXRXDAT), (I3C_DEVICE_TX_BUF_CNT * 4));
