...
void VCOM_LineCoding(uint8_t port)
{
    ...
    if(port == 0)
    {
        ...
        CLK_SetModuleClock(UART0_MODULE, CLK_CLKSEL1_UART0SEL_HIRC_DIV2, CLK_CLKDIV0_UART0(u32Div + 1));
    ...
    else
    {
        ...
        CLK_SetModuleClock(UART1_MODULE, CLK_CLKSEL1_UART1SEL_HIRC_DIV2, CLK_CLKDIV0_UART1(u32Div + 1));
