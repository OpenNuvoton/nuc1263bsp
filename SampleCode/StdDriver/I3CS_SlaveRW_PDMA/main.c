...
int32_t I3CS_EnableRxPDMA(I3CS_T *i3cs, uint32_t u32Src, uint32_t u32Dest, uint32_t u32ByteCnts);
int32_t I3CS_EnableTxPDMA(I3CS_T *i3cs, uint32_t u32Src, uint32_t u32Dest, uint32_t u32ByteCnts);
...
{    
    ...
    PDMA->REQSEL0_3 &= ~PDMA_REQSEL0_3_REQSRC0_Msk;
    PDMA->REQSEL0_3 |= (PDMA_I3CS0_RX << PDMA_REQSEL0_3_REQSRC0_Pos);
...
{    
    ...
    PDMA->REQSEL0_3 &= ~PDMA_REQSEL0_3_REQSRC1_Msk;
    PDMA->REQSEL0_3 |= (PDMA_I3CS0_TX << PDMA_REQSEL0_3_REQSRC1_Pos);
...
int main(void)
{
    ...
    I3CS_EnableRxPDMA(I3CS0, (uint32_t)(&I3CS0->TXRXDAT), (uint32_t)(&g_RxBuf[0]), (I3CS_DEVICE_RX_BUF_CNT * 4));
                ...
                if(g_u32RespStatus == I3CS_STS_NO_ERR)
                {
                    ...
                    do {
                        if(I3CS_IS_RESP_RX(g_RespQ[qn]))
                        {
                            ...
                            u8TID = (pu8Data[0] % 8);
                            I3CS_SetCmdQueueAndData(I3CS0, u8TID, NULL, u16Len);
                            /* Enable I3C PDMA transmit function */
                            I3CS_EnableTxPDMA(I3CS0, (uint32_t)(&g_TxBuf[0]), (uint32_t)(&I3CS0->TXRXDAT), (I3CS_DEVICE_TX_BUF_CNT * 4));
