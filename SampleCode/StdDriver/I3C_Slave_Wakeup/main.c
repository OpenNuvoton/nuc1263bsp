 ...
 * @file     main.c
 * @version  V3.00
 * @brief    Wake up the MCU from Power-down mode after receiving CCC or read/write request from the Master.
 *
...
/**
  * @brief  System enter to Power-down mode.
  */
void PowerDownFunction(void)
{
...
int main(void)
{
    ...
    printf("# System always runs in Power-down mode to wait request from the Master.\n");
